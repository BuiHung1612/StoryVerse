...
val EnglishDictionary: Map<AppStringKey, String> = mapOf(
    ...
    AppStringKey.DETAIL_DOWNLOADING to "Downloading {0}%",
    AppStringKey.DETAIL_DOWNLOAD_SUCCESS to "Download completed successfully!",
    AppStringKey.DETAIL_DOWNLOAD_FAILED to "Download failed: {0}",
    AppStringKey.DETAIL_READING_NOW to "Reading",
